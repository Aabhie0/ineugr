...
df = pd.read_csv(r"C:\Users\lenovo\Documents\Datasets\grnmih\grmckh\grmckh\SouthGermanCredit\SouthGermanCredit.asc",sep=' ')
df
...
for i in discrete_variable:
    #  17 Feature In Discrete Variable
    if plotnumber <= 17:
...
for i in continous_variable:
    #  4 Feature In Continous Variable
    if plotnumber <= 4:
...
df.to_csv(r'C:\Users\lenovo\Documents\Datasets\grnmih\grmckh\grmckh\SouthGermanCredit\Preprocess.csv')
